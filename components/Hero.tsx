  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(13, 148, 136, 0.12) 0%, transparent 55%), radial-gradient(ellipse 60% 40% at 80% 60%, rgba(37, 99, 235, 0.08) 0%, transparent 50%)',
        }}
      />
          ...
          >
            <div className="mx-auto lg:mx-0 max-w-lg flex flex-col gap-5 sm:gap-6">
              ...
              <motion.p
                ...
                className="text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-relaxed min-h-[3.25rem] flex flex-wrap items-center justify-center lg:justify-start gap-x-1"
                aria-live="polite"
                aria-atomic="true"
              >
                ...
                {!prefersReducedMotion && (
                  <motion.span
                    ...
                    className="inline-block w-0.5 h-4 sm:h-5 bg-teal-500 rounded-full shrink-0 align-middle"
                    aria-hidden
                  />
                )}
              </motion.p>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
                <motion.a
                  ...
                  className="inline-flex items-center justify-center gap-2 min-h-[44px] px-6 py-3 rounded-lg bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600 text-white text-sm font-semibold shadow-sm hover:shadow transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-950"
                ...
                <motion.a
                  ...
                  className="inline-flex items-center justify-center gap-2 min-h-[44px] px-5 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 text-sm font-medium hover:border-teal-400/60 hover:text-teal-600 dark:hover:text-teal-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-950"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
            ...
            <div className="relative flex items-center justify-center w-52 h-52 sm:w-64 sm:h-64 lg:w-72 lg:h-72">
              ...
              <div className="absolute inset-[5px] rounded-full overflow-hidden z-10 shadow-inner ring-1 ring-slate-200/40 dark:ring-slate-700/40">
                <Image
                  ...
                  alt="Software and DevOps Engineer - profile photo"
                  fill
